...
const CONFIG = {
    API_URL: "https://webapi69728dc5398706830b48c3ac-production.up.railway.app"
};
...
(function() {
    ...
    function getBoardId() {
        ...
        console.warn('Mentor trackwwwwwwwsswwwing: CONFIG.API_URL not available or does not contain valid boardId pattern');
        return null;
    }
